...
PLAID_PRODUCTS = "auth,transactions".split(',')

# PLAID_COUNTRY_CODES is a comma-separated list of countries for which users
# will be able to select institutions from.
PLAID_COUNTRY_CODES = "US,CA".split(',')
...
# @plaid_link.route('/api/info', methods=['POST'])
def info():
    global access_token
    global item_id
    return jsonify({
...
# @plaid_link.route('/api/create_link_token_for_payment', methods=['POST'])
...
def get_access_token(link_token):
    global access_token
    global item_id
    global transfer_id
...
# @plaid_link.route('/api/assets', methods=['GET'])
def get_assets():
    try:
...
# @plaid_link.route('/api/holdings', methods=['GET'])
def get_holdings():
    try:
...
# @plaid_link.route('/api/investments_transactions', methods=['GET'])
...
# @plaid_link.route('/api/transfer', methods=['GET'])
def transfer():
    global transfer_id
    try:
...
# @plaid_link.route('/api/payment', methods=['GET'])
def payment():
    global payment_id
    try:
